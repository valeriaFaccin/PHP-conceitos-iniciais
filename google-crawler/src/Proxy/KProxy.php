...
use GuzzleHttp\Exception\{ConnectException, GuzzleException, ServerException};
...
class KProxy implements GoogleProxyInterface
{
    ...
    public function __construct(int $serverNumber)
    {
        ...
        $this->serverNumber = $serverNumber; //I do not see any typos
        $this->endpoint = "http://server{$serverNumber}.kproxy.com";
    }

    /**
     * {@inheritdoc}
     * @throws ServerException If the proxy was overused
     * @throws ConnectException If the proxy is unavailable
