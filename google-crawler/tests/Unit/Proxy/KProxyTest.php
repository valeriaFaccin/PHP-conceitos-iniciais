...
use CViniciusSDias\GoogleCrawler\{
    Exception\InvalidResultException,
    Proxy\KProxy
};
...
{
    public function testInstantiateWithServerNumberLowerThanOneMustThrowException(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new KProxy(0);
    }

    public function testInstantiateWithServerNumberBiggerThanNineMustThrowException(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        new KProxy(10);
    }

    public function testInstantiateWithServerNumberBetweenOneAndNineMustNotThrowException(): void
    {
        $kProxy = new KProxy(1);
