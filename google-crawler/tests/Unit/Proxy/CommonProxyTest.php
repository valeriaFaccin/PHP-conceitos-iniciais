...
{
    public function testInstantiateCommonProxyWithInvalidUrlMustThrowException(): void
    {
    ...
    public function testUrlMustBeCorrectlyParsed(): void
    {
    ...
    public function testUrlFromGoogleSuggestionMustThrowInvalidResultException(): void
    {
